...
import "../interfaces/kim/IKimPool.sol";
import "../interfaces/kim/IKimPlugin.sol";
import "./TickMath.sol";

/// @title Oracle library
/// @notice Provides functions to integrate with Algebra pool oracle
library KimOracleLibrary {
        ...
        returns (int24 arithmeticMeanTick, uint128 harmonicMeanLiquidity)
    {
        ...
        (int56[] memory tickCumulatives, uint88[] memory volatilityCumulatives) =
            IKimPlugin(IKimPool(pool).plugin()).getTimepoints(secondsAgos);
