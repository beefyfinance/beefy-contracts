...
// File contracts/BIFI/strategies/Common/StrategySyrup.sol


pragma solidity ^0.6.12;
contract StrategyXSyrup is StratManager, FeeManager {
    ...
    function callReward() public view returns (uint256) {
        ...
        if (output != native) {
            ...
            reward = amountsOut[amountsOut.length - 1].mul(45).div(1000).mul(callFee).div(MAX_FEE);
        } else {
            reward = outputBal.mul(45).div(1000).mul(callFee).div(MAX_FEE);
        }
