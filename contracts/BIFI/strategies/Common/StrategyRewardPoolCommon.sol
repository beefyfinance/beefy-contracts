...
contract StrategyRewardPoolCommon is StratManager, FeeManager {
    ...
    constructor(
        ...
        address[] memory _outputToPairedWithLp0Route,
        address[] memory _outputToPairedWithLp1Route
        ...
        outputToLp0Route = _outputToPairedWithLp0Route;
        outputToLp0Route.push(lpToken0);

        outputToLp1Route = _outputToPairedWithLp1Route;
        outputToLp1Route.push(lpToken1);
    ...
    function chargeFees() internal {
        ...
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(toMatic, 0, outputToNativeRoute, address(this), now);

        uint256 maticBal = IERC20(native).balanceOf(address(this));
