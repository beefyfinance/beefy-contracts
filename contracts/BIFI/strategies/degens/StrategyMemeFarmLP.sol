...
/**
 * @dev Implementation of a strategy to get yields from farming LP Pools in MemeFarm.
 *
 * This strat is currently compatible with all LP pools.
 */
contract StrategyMemeFarmLP is Ownable, Pausable {
     ...
     * {output} - Token generated by staking our funds. In this case it's the MFRM token.
