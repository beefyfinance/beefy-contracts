...
/**
 * @dev Implementation of a strategy to get yields from farming LP Pools in ZCore Finance.
 *
 * This strat is currently compatible with all LP pools.
 */
contract StrategyZefiLP is Ownable, Pausable, GasThrottler {
     ...
     * {output} - Token generated by staking our funds. In this case it's the ZEFI token.
