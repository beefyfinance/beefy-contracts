...
contract BeefybsFTMRewardPool is LPTokenWrapper, Ownable {
    ...
    constructor(address _stakedToken, address _rewardToken, address _bsFTM)
        public
    ...
    function claimAndNotify() public {
        ...
        IbsFTM(bsFTM).claimStakingReward();
    ...
    function setbsFTM(address _bsFTM) external onlyOwner {
        bsFTM = _bsFTM;
    }
