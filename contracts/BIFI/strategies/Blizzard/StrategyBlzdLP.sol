 ...
 * BLZD rewards from providing liquidity are farmed every few minutes, sold and split 50/50.
 ...
 */
contract StrategyBlzdLP is Ownable, Pausable {
     ...
     * {blzd} - Token generated by staking our funds. In this case it's the CAKEs token.
    ...
    address constant public output = address(0x57067A6BD75c0E95a6A5f158455926e43E79BeB0);
    ...
    address constant public masterchef = address(0x2078F4A75c92A6918D13e3e2F14183443ebf55D3);
    uint8 public poolId;
