...
/**
 * @dev Implementation of a strategy to get yields from farming Synthetix based rewards pools. LP tokens are staked
 * and rewards are paid out in BHC.
 * 
...
contract StrategyThugsLP is Ownable, Pausable {
     ...
     * {bhc} - Token generated by staking our funds. In this case it's the BHC token.
     ...
     * {rewardPool} - Reward pool configured through constructor
     */
    address immutable public unirouter;
   ...
   */
     ...
     * {bhcToWbnbRoute} - Route we take to get from {bhc} into {wbnb}.
     * {wbnbToBifiRoute} - Route we take to get from {wbnb} into {bifi}.
     * {bhcToLp0Route} - Route we take to get from {bhc} into {lpToken0}.
     * {bhcToLp1Route} - Route we take to get from {bhc} into {lpToken1}.
     */
    address[] public bhcToWbnbRoute = [bhc, wbnb];
    address[] public wbnbToBifiRoute = [wbnb, bifi];
    address[] public bhcToLp0Route;
    address[] public bhcToLp1Route;
     ...
     */
    constructor(address _lpPair, address _vault, address _unirouter, address _strategist) public {
        lpPair = _lpPair;
