...
const KEEPER = beefyfinance.keeper;
const chainName = "emerald";

const config = {
  bifi: false, // addressBook[chainName].tokens.BIFI.address,
  wnative: ROSE,
  rpc: "https://emerald.oasis.dev",
  chainName: chainName,
  chainId: 42262,
  devMultisig: beefyfinance.devMultisig,
  treasuryMultisig: beefyfinance.treasuryMultisig,
  multicall: beefyfinance.multicall,
  vaultOwner: false,
  stratOwner: false,
