...
contract StrategyOldCurveConvexTest is BaseStrategyTest {
    ...
    address constant triUSDC = 0x7F86Bf177Dd4F3494b841a37e810A34dD56c829B;
    ...
    // hyUSD-eUSD
    address want = 0xc794C6A95f30d0ebF7B3Bbe85e8a0A95C9e411c1;
    address gauge = 0x27cace18f661161661683bBA43933B2E6eB1741E;
    uint pid = 183;
    bytes crvToNativePath = crvToNativeUniV3;
    bytes cvxToNativePath = cvxToNativeUniV3;
    bytes nativeToDepositPath = "";
    address[9] depositToWant = [native, triUSDC, usdc, 0xAEda92e6A3B1028edc139A4ae56Ec881f3064D4F, 0xA0d69E286B938e21CBf7E51D71F6A4c8918f482F, 0x8a8434A5952aC2CF4927bbEa3ace255c6dd165CD, want];
    uint[3][4] depositToWantParams = [[2,0,3],[2,0,2],[1,0,7]];
