...
echo "// SPDX-License-Identifier: MIT" > tmp/StrategyCommonAuroraChefLP.sol
...
truffle-flattener contracts/BIFI/strategies/Aurora/StrategyAuroraChefLP.sol | sed '/SPDX-License-Identifier/d' >> tmp/StrategyCommonAuroraChefLP.sol
