...
echo "// SPDX-License-Identifier: MIT" > tmp/StrategyCommonChefLPBsc.sol
...
truffle-flattener contracts/BIFI/strategies/Common/StrategyCommonChefLPBsc.sol | sed '/SPDX-License-Identifier/d' >> tmp/StrategyCommonChefLPBsc.sol
