...
echo "// SPDX-License-Identifier: MIT" > tmp/Strat.sol
...
truffle-flattener contracts/BIFI/strategies/LendHub/StrategyLendhub.sol | sed '/SPDX-License-Identifier/d' >> tmp/Strat.sol
