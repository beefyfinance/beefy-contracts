...
echo "// SPDX-License-Identifier: MIT" > tmp/StrategyQuickswapDualRewardLP.sol
...
truffle-flattener contracts/BIFI/strategies/QuickSwap/StrategyQuickswapDualRewardLP.sol | sed '/SPDX-License-Identifier/d' >> tmp/StrategyQuickswapDualRewardLP.sol
