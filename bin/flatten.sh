...
echo "// SPDX-License-Identifier: MIT" > tmp/StrategyTombTSHARE.sol
...
truffle-flattener contracts/BIFI/strategies/Tomb/StrategyTombTSHARE.sol | sed '/SPDX-License-Identifier/d' >> tmp/StrategyTombTSHARE.sol
