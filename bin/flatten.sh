...
echo "// SPDX-License-Identifier: MIT" > tmp/StrategyStellaMultiRewardsLP.sol
...
truffle-flattener contracts/BIFI/strategies/Moonbeam/StrategyStellaMultiRewardsLP.sol | sed '/SPDX-License-Identifier/d' >> tmp/StrategyStellaMultiRewardsLP.sol
