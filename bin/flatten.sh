...
echo "// SPDX-License-Identifier: MIT" > tmp/StrategyRoseLP.sol
...
truffle-flattener contracts/BIFI/strategies/Aurora/StrategyRoseLP.sol | sed '/SPDX-License-Identifier/d' >> tmp/StrategyRoseLP.sol
