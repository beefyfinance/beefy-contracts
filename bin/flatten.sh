...
echo "// SPDX-License-Identifier: MIT" > tmp/StrategyBeJoeRewardPool.sol
...
echo "// SPDX-License-Identifier: MIT" > tmp/VeJoeStaker.sol
...
truffle-flattener contracts/BIFI/strategies/veJOE/StrategyBeJoeRewardPool.sol | sed '/SPDX-License-Identifier/d' >> tmp/StrategyBeJoeRewardPool.sol
truffle-flattener contracts/BIFI/strategies/veJoe/VeJoeStaker.sol | sed '/SPDX-License-Identifier/d' >> tmp/VeJoeStaker.sol
